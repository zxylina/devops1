...
class Server(models.Model):
    ...
    model_name          = models.ForeignKey(ProductModel, verbose_name="服务型号", help_text="服务器型号")
    # rmt_card_ip         = models.CharField("管理管理卡IP", max_length=15, db_index=True, help_text="管理管理卡IP")
